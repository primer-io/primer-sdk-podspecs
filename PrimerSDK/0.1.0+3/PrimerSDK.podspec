#
#  Be sure to run `pod spec lint PrimerSDK.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # spec.authors            = { "Carl" => "carl@primer.io" }
  ...
  spec.source       = { :git => "git@github.com:primer-io/primer-sdk-ios.git", :tag => "#{spec.version}" }
